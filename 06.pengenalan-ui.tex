\chapter{PENGENALAN DATA SIG PADA APLIKASI QGIS}
...
\end{figure}
  ...
  \begin{itemize}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=1\textwidth]{./resources/012-sample-identify-feature}
  ...
  \begin{itemize}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=1\textwidth]{./resources/013-menu-atribut-tabel}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=1\textwidth]{./resources/014-tabel-atribut}
